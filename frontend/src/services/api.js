...
export const checkEnrollment = (courseId, studentAddress) =>
  api.get(`/courses/${courseId}/enrollment-check`, {
...
export const getMySubmission = (courseId, studentAddress) =>
  api.get(`/courses/${courseId}/submission`, {
    params: { student_address: studentAddress },
  }).then((r) => r.data);

export const checkSubmission = (courseId, studentAddress) =>
  api.get(`/courses/${courseId}/submission-check`, {
    params: { student_address: studentAddress },
  }).then((r) => r.data);

export const createResults = (courseId, data) =>
  api.post(`/courses/${courseId}/results`, data).then((r) => r.data);
...
export const getMyRank = (courseId, studentAddress) =>
  api.get(`/courses/${courseId}/my-rank`, {
    params: { student_address: studentAddress },
  }).then((r) => r.data);
